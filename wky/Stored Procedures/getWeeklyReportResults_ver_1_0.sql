...
/*
​
EXEC [wky].[getWeeklyReportResults_ver_1_0] @Country = 'All',@ReportRunDate='2020-04-26'
​
...
​
​
CREATE PROCEDURE [wky].[getWeeklyReportResults_ver_1_0] 
     ( 
...
------------------------------------------------------------
      ...
      SELECT [Priority]
           ...
           , [Message]
           , Detail
           , cast([Value] as numeric(8,0)) [Value]
